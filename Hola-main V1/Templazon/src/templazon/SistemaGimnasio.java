...
public class SistemaGimnasio {
    ...
    public void menuPrincipal() {
        ...
        do {
            opcion = Integer.parseInt(JOptionPane.showInputDialog(
                    ...
                    + "4. Reservar espacio recreativo\n"
                    + "5. Reserva de clases grupales\n"
                    + "6. Control de sala de pesas\n"
                    + "7. Liberar reserva\n"
                    + "8. Ver reservas\n"
                    + "9. Salir"
            ));
    ...
    void hacerReserva() {
        int id = Integer.parseInt(JOptionPane.showInputDialog("Ingrese ID del socio (0 a 3):"));
        if (id < 0 || id >= socios.length || !socios[id].membresiaActiva) {
            JOptionPane.showMessageDialog(null, "ID inválido o membresía inactiva");
            return;
        }

        String act = JOptionPane.showInputDialog("Actividad a reservar (Clase / Parqueo):");
        if (act.equalsIgnoreCase("parqueo")) {
